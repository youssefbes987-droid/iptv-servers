...
import { LogOut, BarChart3, Users, ShoppingCart, HeadphonesIcon, FileText, Settings } from 'lucide-react';
              ...
              <Link href="/deals">
                <button className="w-full p-4 text-left bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h4 className="font-medium text-blue-900">Manage Deals</h4>
                      <p className="text-sm text-blue-600">View and create IPTV deals</p>
                    </div>
                  </div>
                </button>
              </Link>
                  ...
                  <button className="w-full p-4 text-left bg-green-50 hover:bg-green-100 rounded-lg transition-colors">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-green-600">Create and manage team members</p>
                      </div>
                    </div>
                  </button>
                </Link>
              ...
              <button className="w-full p-4 text-left bg-purple-50 hover:bg-purple-100 rounded-lg transition-colors">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-purple-600">Generate performance analytics</p>
                  </div>
                </div>
              </button>
            </div>
